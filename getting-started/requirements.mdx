    ...
    *copied from the official docs, slightly modified*
    ...
    <Steps>
      <Step title="Install Node.js LTS">
        ...
        <Tabs>
          <Tab title="Debian/Ubuntu" icon="computer">
          ...
          <Tab title="CentOS/RHEL" icon="computer">
            Open a terminal, either via SSH or directly on the server, and run the following commands to install the requires packages and the latest LTS version of Node.js:
            ```bash
...
<Card title="Installation Guide" icon="download" href="/getting-started/installation" arrow="true">
  Step-by-step instructions for installing Plex Development products on your operating system.
</Card>